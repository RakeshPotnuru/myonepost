...
export default function FeedTabsList() {
  ...
  return (
    <TabsList className="sticky top-0 z-50 grid h-12 w-full grid-cols-3 divide-x rounded-none rounded-b-xl border border-t-0 bg-transparent p-0 backdrop-blur-xl *:h-full *:rounded-none">
      <TabsTrigger
