...
export const PostScalarFieldEnumSchema = z.enum(["id","createdAt","updatedAt","postType","text","imageUrl","videoUrl","audioUrl","userId","commentCount","likeCount","bookmarkCount"]);
...
export const UserScalarFieldEnumSchema = z.enum(["id","createdAt","updatedAt","email","username","displayName","bio","avatar","isFlagged","flagReason","profileViews","nextPostAllowedAt","bookmarksVisibility"]);
...
export const PostSelectSchema: z.ZodType<Prisma.PostSelect> = z.object({
  ...
  bookmarkCount: z.boolean().optional(),
  user: z.union([z.boolean(),z.lazy(() => UserArgsSchema)]).optional(),
  comments: z.union([z.boolean(),z.lazy(() => CommentFindManyArgsSchema)]).optional(),
  likes: z.union([z.boolean(),z.lazy(() => LikeFindManyArgsSchema)]).optional(),
  bookmarks: z.union([z.boolean(),z.lazy(() => BookmarkFindManyArgsSchema)]).optional(),
...
export const PostWhereInputSchema: z.ZodType<Prisma.PostWhereInput> = z.object({
  ...
  bookmarkCount: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
...
export const PostOrderByWithRelationInputSchema: z.ZodType<Prisma.PostOrderByWithRelationInput> = z.object({
  ...
  bookmarkCount: z.lazy(() => SortOrderSchema).optional(),
...
.and(z.object({
  ...
  bookmarkCount: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  user: z.union([ z.lazy(() => UserRelationFilterSchema),z.lazy(() => UserWhereInputSchema) ]).optional(),
  comments: z.lazy(() => CommentListRelationFilterSchema).optional(),
  likes: z.lazy(() => LikeListRelationFilterSchema).optional(),
  bookmarks: z.lazy(() => BookmarkListRelationFilterSchema).optional()
...
export const PostScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PostScalarWhereWithAggregatesInput> = z.object({
  ...
  bookmarkCount: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
}).strict();
...
export const PostUpdateInputSchema: z.ZodType<Prisma.PostUpdateInput> = z.object({
  ...
  bookmarkCount: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BookmarkUpdateManyMutationInputSchema: z.ZodType<Prisma.BookmarkUpdateManyMutationInput> = z.object({}).strict();
